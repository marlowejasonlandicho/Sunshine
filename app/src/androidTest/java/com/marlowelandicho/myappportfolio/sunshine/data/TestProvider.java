package com.marlowelandicho.myappportfolio.sunshine.data;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        ...
        assertEquals("Error: the WeatherContract.WeatherEntry CONTENT_URI should return WeatherContract.WeatherEntry.CONTENT_TYPE",
        ...
        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
        assertEquals("Error: the WeatherContract.WeatherEntry CONTENT_URI with location should return WeatherContract.WeatherEntry.CONTENT_TYPE",
                WeatherContract.WeatherEntry.CONTENT_TYPE, type);
        ...
        assertEquals("Error: the WeatherContract.WeatherEntry CONTENT_URI with location and date should return WeatherContract.WeatherEntry.CONTENT_ITEM_TYPE",
        ...
        assertEquals("Error: the WeatherContract.LocationEntry CONTENT_URI should return WeatherContract.LocationEntry.CONTENT_TYPE",
    ...
    public void testBasicWeatherQuery() {
        ...
        assertTrue("Unable to Insert WeatherContract.WeatherEntry into the Database", weatherRowId != -1);
    ...
    public void testInsertReadProvider() {
        ...
        TestUtilities.validateCursor("testInsertReadProvider. Error validating WeatherContract.WeatherEntry insert.",
    ...
    public void testBulkInsert() {
        ...
        for (int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++, cursor.moveToNext()) {
            TestUtilities.validateCurrentRecord("testBulkInsert.  Error validating WeatherContract.WeatherEntry " + i,
